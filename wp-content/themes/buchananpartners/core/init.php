...
if(!function_exists('cpotheme_setup')){
	...
	function cpotheme_setup(){
		...
		if(!defined('CPOTHEME_PREMIUM_NAME')) define('CPOTHEME_PREMIUM_NAME', __('Premium Version', 'buchananpartners'));
		if(!defined('CPOTHEME_PREMIUM_URL')) define('CPOTHEME_PREMIUM_URL', '');
		...
		load_theme_textdomain('buchananpartners', $languages_path);
		$locale = get_locale();
