...
if(!function_exists('cpotheme_metadata_layoutstyle')){
	function cpotheme_metadata_layoutstyle(){
		$data = array(
		'fixed' => __('Full Width', 'buchananpartners'),
		'boxed' => __('Boxed', 'buchananpartners'));
		return $data;
	}
}
...
function cpotheme_metadata_featured_page(){
	$data = array(
	'none' => __('None', 'buchananpartners'),
	'slider' => __('In The Slider', 'buchananpartners'),
	'features' => __('In The Featured Boxes', 'buchananpartners'));
