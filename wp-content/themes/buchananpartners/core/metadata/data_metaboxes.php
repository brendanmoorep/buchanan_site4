...
function cpotheme_metadata_layout_options(){
	...
	'name' => 'layout_sidebar',
	'label' => __('Sidebar Position', 'buchananpartners'),
	'desc' => __('Determines the location of the sidebar by default.', 'buchananpartners'),
	'type' => 'imagelist',
...
function cpotheme_metadata_feature_options(){
	...
	'name' => 'feature_icon',
	'std'  => '',
	'label' => __('Feature Icon', 'buchananpartners'),
	'desc' => __('Sets an icon to be used as the featured element.', 'buchananpartners'),
	'type' => 'iconlist');
...
function cpotheme_metadata_portfolio_options(){
	...
	'std'  => '',
	'label' => __('Featured Item', 'buchananpartners'),
	'desc' => __('Specifies whether this item appears in the homepage.', 'buchananpartners'),
	'type' => 'yesno');
...
function cpotheme_metadata_service_options(){
	...
	'name' => 'service_icon',
	'std'  => '',
	'label' => __('Service Icon', 'buchananpartners'),
	'desc' => __('Sets an icon to be used as the service preview.', 'buchananpartners'),
	'type' => 'iconlist');
...
function cpotheme_metadata_team_options(){
	...
	'name' => 'team_featured',
	'std'  => '',
	'label' => __('Principal', 'buchananpartners'), //TODO: this was edited by Brendan MP
	'desc' => __('Specifies whether this team member is a Pincipal member or not.', 'buchananpartners'),
	'type' => 'yesno');

    $data['team_founding_principal'] = array(
        'name' => 'team_founding_principal',
        'std'  => '',
        'label' => __('Founding Principal', 'buchananpartners'), //TODO: this was edited by Brendan MP
        'desc' => __('Specifies whether this team member is a Fouding Pincipal member or not.', 'buchananpartners'),
        'type' => 'yesno');
...
function cpotheme_metadata_page_options(){
	...
	'name' => 'page_featured',
	'std'  => '',
	'label' => __('Show In Homepage', 'buchananpartners'),
	'desc' => __('Specifies whether this item is featured in the homepage.', 'buchananpartners'),
	'type' => 'select',
