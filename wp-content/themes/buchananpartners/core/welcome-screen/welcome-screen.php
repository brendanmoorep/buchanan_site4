...
class Allegiant_Welcome {
	...
	public function allegiant_welcome_admin_notice() {
		...
		<div class="updated notice is-dismissible">
			<p><?php echo sprintf( esc_html__( 'Welcome! Thank you for choosing Allegiant! To fully take advantage of the best our theme can offer please make sure you visit our %swelcome page%s.', 'buchananpartners' ), '<a href="' . esc_url( admin_url( 'themes.php?page=cpotheme-welcome' ) ) . '">', '</a>' ); ?></p>
			<p><a href="<?php echo esc_url( admin_url( 'themes.php?page=cpotheme-welcome' ) ); ?>" class="button"
			      style="text-decoration: none;"><?php _e( 'Get started with Allegiant', 'buchananpartners' ); ?></a></p>
		</div>
		<?php
	}
	...
	public function allegiant_welcome_style_and_scripts( $hook_suffix ) {
		...
		if ( $screen->base != 'customize' ) {
			...
			wp_localize_script( 'cpotheme-welcome-screen-js', 'allegiantWelcomeScreenObject', array(
				...
				'no_required_actions_text' => __( 'Hooray! There are no required actions for you right now.', 'buchananpartners' )
			) );
		}
		...
		<div class="wrap about-wrap epsilon-wrap">
			...
			<h2 class="nav-tab-wrapper wp-clearfix">
				<a href="<?php echo admin_url( 'themes.php?page=cpotheme-welcome&tab=getting_started' ); ?>"
				   class="nav-tab <?php echo $active_tab == 'getting_started' ? 'nav-tab-active' : ''; ?>"><?php echo esc_html__( 'Getting Started', 'buchananpartners' ); ?></a>
				<a href="<?php echo admin_url( 'themes.php?page=cpotheme-welcome&tab=recommended_actions' ); ?>"
				   class="nav-tab <?php echo $active_tab == 'recommended_actions' ? 'nav-tab-active' : ''; ?> "><?php echo esc_html__( 'Recommended Actions', 'buchananpartners' ); ?>
				...
				<a href="<?php echo admin_url( 'themes.php?page=cpotheme-welcome&tab=recommended_plugins' ); ?>"
				   class="nav-tab <?php echo $active_tab == 'recommended_plugins' ? 'nav-tab-active' : ''; ?> "><?php echo esc_html__( 'Recommended Plugins', 'buchananpartners' ); ?></a>
				<a href="<?php echo admin_url( 'themes.php?page=cpotheme-welcome&tab=support' ); ?>"
				   class="nav-tab <?php echo $active_tab == 'support' ? 'nav-tab-active' : ''; ?> "><?php echo esc_html__( 'Support', 'buchananpartners' ); ?></a>
				<a href="<?php echo admin_url( 'themes.php?page=cpotheme-welcome&tab=features' ); ?>"
				   class="nav-tab <?php echo $active_tab == 'features' ? 'nav-tab-active' : ''; ?> "><?php echo esc_html__( 'Lite vs PRO', 'buchananpartners' ); ?></a>
			</h2>
